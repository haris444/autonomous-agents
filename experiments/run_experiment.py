...
Usage:
    python run_experiment.py experiments/configs/my_experiment.yaml
    python run_experiment.py experiments/configs/my_experiment.yaml --dry-run
    python run_experiment.py experiments/configs/my_experiment.yaml --n_envs 16
    python run_experiment.py experiments/configs/my_experiment.yaml --timesteps 1000
"""
import argparse
import csv
import os
...
from training.train_vec import train_vec
